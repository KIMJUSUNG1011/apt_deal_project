...
public class LoggingAspect {
	...
	@AfterReturning(value = "execution(* com.ssafy.home.model..*.list*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.home.model..*.list*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.home.model..*.list*(..))")
